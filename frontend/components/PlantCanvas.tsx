...
const PlantCanvas: React.FC<PlantCanvasProps> = ({
  ...
  const drawOrganicVine = (
    ...
    const totalSegments =
      segments * (growthRef.current / 100) * individualGrowth; // 使用独立生长进度
    ...
    >
      ...
      {labState === "GROWING" && (
        <div
          ...
          data-oid="cp4:m9c"
        >
          <div data-oid="leg96rm">
            STRESS: {(stressRef.current * 100).toFixed(0)}%
          </div>
          <div className="w-24 h-1 bg-gray-200 mt-1" data-oid="yvdg46e">
            <div
          ...
          <div className="mt-2" data-oid="de_haxh">
            ENERGY: {(energyRef.current * 100).toFixed(0)}%
          </div>
          <div className="text-gray-400 mt-1" data-oid="3z0gnpr">
